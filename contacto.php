...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
	<title>Asesorias ITT - Contactar</title>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2">
                <h2>Contacto</h2>
                <p>Si quiere hacernos llegar un comentario y/o sugerencia para seguir mejorando el Sistema de Asesor&iacute;as ITT, por favor llene el siguiente formulario y nos pondremos en contacto lo m&aacute;s pronto con usted.</p>
                  <?php
