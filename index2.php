<?php
  ...
  $sql = "SELECT * FROM usuario WHERE numcontrol = '$idUsuario'";
  $result=$mysqli->query($sql);
  
  $row = $result->fetch_assoc();

  //Para mostrar nombre de su carrera y no su numero (id de carrera)
  $sqlcarrea = "SELECT carreras.descripC FROM carreras, usuario WHERE carreras.carreraid = ".$row['id_carrera']." AND usuario.id_carrera = ".$row['id_carrera']."";
