...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
	<title>Sistema de Asesorias ITT</title>
...
.business-header {
    height: 300px;
    background: url('images/fondo.jpg') center center no-repeat scroll;
...
<div class="mdl-layout mdl-js-layout">
  <header class="mdl-layout__header mdl-layout__header--scroll">
    <div class="mdl-layout__header-row">
      <!-- Titulo -->
      <span class="mdl-layout-title">Sistema de Asesor&iacute;as ITT</span>
  ...
  <main class="mdl-layout__content">
    ...
    <header class="business-header">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="tagline">Asesor&iacute;as ITT</h1>
                </div>
            </div>
        </div>
    </header>
 ...
 <!-- Contenido de la pagina -->
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-8">
                <h2>Bienvenidos</h2>
                <p>El nuevo Sistema de Asesorias del Instituto Tecnol&oacute;gico de Tijuana permite a los estudiantes crear sus propias asesor&iacute;as, as&iacute; como inscribirse a las asesori&iacute;as creadas. </p>
                <p>La meta del proyecto es crear una p&aacute;gina web de facil manejo e interfaz amigable para el usuario y sea 100% funcional para cualquier alumno que la requiera.</p>
                
            </div>
            </br>
            </br>
            </br>
            <img src="images/itt45.png" alt="Aniversario ITT" />

            <!--Carta del lado derecho-->
            <!--
            <div class="col-sm-4">
                </br>
                <div class="demo-card-square mdl-card mdl-shadow--2dp">
                  <div class="mdl-card__title mdl-card--expand">
                    <h2 class="mdl-card__title-text">Registrate</h2>
                  </div>
                  <div class="mdl-card__supporting-text">
                    Atrevete a ser mejor.
                  </div>
                    ...
                    <ul class="list-inline banner-social-buttons">
                        <li>
                            <!-- Flat button with ripple -->
                              ...
                              <a href="login.php">
                            <button class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored" href="login.php">
                              Comenzar Ya!
                            </button>
                            </a>
                        </li>
                        <!-- Para acomodar el primer y unico boton XDDDD -->
                        <li></li>
                        <li></li>
                        <li></li>
                        <li></li>
...
<!-- /.banner -->
    ...
    <footer class="mdl-mini-footer">
      <div class="mdl-mini-footer__left-section">
        <div class="mdl-logo">Sistema de Asesor&iacute;as ITT</div>
...
https://github.com/BlackrockDigital/startbootstrap-landing-page
    ...
    <div class="demo-card-wide mdl-card mdl-shadow--2dp">
      <div class="mdl-card__title">
        <h2 class="mdl-card__title-text"><b>Sistema de Asesor&iacute;as ITT</b></h2>
      </div>
      <div class="mdl-card__supporting-text">
